// create User Login form to obtain username and password 
// withRoute HOC for access url, params, history, 
...
export const AuthPrompt = withRouter(authWrapper(class extends Component {
    constructor(props) {
        ...
        // define defaultAttrs and formModel to pass into <ValidatedForm>
